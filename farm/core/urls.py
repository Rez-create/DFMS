...
urlpatterns = [
    ...
    path("animal_records/<str:ear_tag>/edit/", views.animal_records, name='animal-records-edit'),
    ...
    path("milk_records/<str:record_id>/edit/", views.milk_records, name='milk-records-edit'),
    ...
    path("milk_sale/<str:sale_id>/edit/", views.milk_sale, name='milk-sale-edit'),
    ...
    path("breeding/<str:breeding_id>/edit/", views.breeding, name='breeding-records-edit'),
    ...
    path("stock_feeds/<str:feed_id>/edit/", views.stock_feeds, name='feed-records-edit'),
